...
/**
 * CreateDockerimageApplicationRequest Class Doc Comment
 *
 * @category Class
 * @package  CoolifyPHP\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateDockerimageApplicationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_dockerimage_application_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['docker_registry_image_name'] === null) {
            $invalidProperties[] = "'docker_registry_image_name' can't be null";
        }
     ...
     *
     * @param string $docker_registry_image_name The docker registry image name.
     *
     * @return self
     */
