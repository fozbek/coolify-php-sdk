...
/**
 * CreatePrivateGithubAppApplicationRequest Class Doc Comment
 *
 * @category Class
 * @package  CoolifyPHP\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePrivateGithubAppApplicationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_private_github_app_application_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['github_app_uuid'] === null) {
            $invalidProperties[] = "'github_app_uuid' can't be null";
        }
     ...
     *
     * @param string $github_app_uuid The Github App UUID.
     *
     * @return self
     */
