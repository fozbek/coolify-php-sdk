...
/**
 * CreateDatabaseMongodbRequest Class Doc Comment
 *
 * @category Class
 * @package  CoolifyPHP\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateDatabaseMongodbRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_database_mongodb_request';
    ...
    */
     ...
     * Sets mongo_conf
     *
     * @param string|null $mongo_conf MongoDB conf
     *
     * @return self
     */
     ...
     *
     * @param string|null $mongo_initdb_root_username MongoDB initdb root username
     *
     * @return self
     */
