...
/**
 * CreatePrivateDeployKeyApplicationRequest Class Doc Comment
 *
 * @category Class
 * @package  CoolifyPHP\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePrivateDeployKeyApplicationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_private_deploy_key_application_request';
    ...
    public const STATIC_IMAGE_NGINX_ALPINE = 'nginx:alpine';
     ...
     * @return string[]
     */
    public function getStaticImageAllowableValues()
    {
        return [
            self::STATIC_IMAGE_NGINX_ALPINE,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['private_key_uuid'] === null) {
            $invalidProperties[] = "'private_key_uuid' can't be null";
        }
        if ($this->container['git_repository'] === null) {
            $invalidProperties[] = "'git_repository' can't be null";
        }
        if ($this->container['git_branch'] === null) {
            $invalidProperties[] = "'git_branch' can't be null";
        }
        if ($this->container['ports_exposes'] === null) {
            $invalidProperties[] = "'ports_exposes' can't be null";
        }
        if ($this->container['build_pack'] === null) {
            $invalidProperties[] = "'build_pack' can't be null";
        }
        ...
        $allowedValues = $this->getStaticImageAllowableValues();
        if (!is_null($this->container['static_image']) && !in_array($this->container['static_image'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'static_image', must be one of '%s'",
                $this->container['static_image'],
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param string $private_key_uuid The private key UUID.
     *
     * @return self
     */
     ...
     * Sets git_branch
     *
     * @param string $git_branch The git branch.
     *
     * @return self
     */
     ...
     * Sets ports_exposes
     *
     * @param string $ports_exposes The ports to expose.
     *
     * @return self
     */
     ...
     * Sets build_pack
     *
     * @param string $build_pack The build pack type.
     *
     * @return self
     */
     ...
     * Sets static_image
     *
     * @param string|null $static_image The static image.
     *
     * @return self
     */
    public function setStaticImage($static_image)
    {
        ...
        $allowedValues = $this->getStaticImageAllowableValues();
        if (!in_array($static_image, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'static_image', must be one of '%s'",
                    $static_image,
